...
// baseService 基础服务
 var BaseService = {
	  ...
	  postForm : function(url,data){
	  	if(!data) data={};
	  	var jsonToFormData = this.jsonToFormData;
	  	return new Promise(function(resolve, reject){
		    axios.post(url, data,{transformRequest:jsonToFormData,headers:{"Content-Type":"application/x-www-form-urlencoded; charset=utf-8"} })
		    	.then(function(response){
		    		resolve(response.data) ;
		    	})
		    	.catch(function(error){
