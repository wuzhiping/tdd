 ...
 * 校验处理入口
 */
FormValidator.doValidate = function(el,binding,vnode,value){
...
//设置校验标记
function setValidity(validity,vnode){
	...
	updateValidCalss(validity===true,vnode);
}
