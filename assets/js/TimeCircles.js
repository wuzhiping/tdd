...
(function($) {
    ...
    var TC_Instance = function(element, options) {
        ...
        for (var key in this.data.text_elements) {
            ...
            numberElement.css("font-size", 12); //  Math.round(0.21 * this.data.attributes.item_size));
            numberElement.css("line-height", "6px"); //  Math.round(0.07 * this.data.attributes.item_size) + "px");
